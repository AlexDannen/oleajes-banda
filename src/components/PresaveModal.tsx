...
const PRESAVE_URL = "https://ffm.to/mujerarticifial";
const STORAGE_KEY = "oleajes-presave-mujer-artificial-dismissed";
...
export default function PresaveModal() {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Pre-save Mujer Artificial"
    >
      {/* Overlay */}
      <div
      ...
      >
        ...
        <div className="relative w-48 h-48 sm:w-56 sm:h-56 mx-auto mb-6 rounded-lg overflow-hidden border border-[#2d3d4f] shadow-[0_0_40px_rgba(74,158,187,0.2)]">
          <Image
            src="/images/mujer-artificial.jpg"
            alt="Portada de Mujer Artificial"
            fill
        ...
        <p className="font-[family-name:var(--font-space)] text-[#7a8a9a] mb-7 leading-relaxed">
          Nuestro nuevo single está por salir. Guárdalo ahora y escúchalo apenas
          esté afuera.
        </p>
        ...
        <TrackedLink
          ...
          analyticsLabel="Pre-save — Mujer Artificial"
          target="_blank"
