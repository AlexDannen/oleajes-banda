      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <div ref={musicRef} className="max-w-xl mx-auto">
          <div className="group relative">
            ...
            <div className={`md:hidden absolute left-1/2 w-44 h-44 transition-all duration-1000 delay-300 ease-out pointer-events-none ${isMusicVisible ? 'top-0 -translate-x-1/2 -translate-y-1/2 opacity-100 z-0' : 'top-0 -translate-x-1/2 translate-y-[10%] opacity-0 -z-10'}`}>
